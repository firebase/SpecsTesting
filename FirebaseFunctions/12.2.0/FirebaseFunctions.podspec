...
Cloud Functions for Firebase.
  ...
  s.dependency 'FirebaseCore', '~> 12.2.0'
  s.dependency 'FirebaseCoreExtension', '~> 12.2.0'
  s.dependency 'FirebaseAppCheckInterop', '~> 12.2.0'
  s.dependency 'FirebaseAuthInterop', '~> 12.2.0'
  s.dependency 'FirebaseMessagingInterop', '~> 12.2.0'
  s.dependency 'FirebaseSharedSwift', '~> 12.2.0'
