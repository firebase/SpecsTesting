...
Cloud Functions for Firebase.
  ...
  s.dependency 'FirebaseCoreExtension', '~> 12.9.0'
  s.dependency 'FirebaseAppCheckInterop', '~> 12.9.0'
  s.dependency 'FirebaseAuthInterop', '~> 12.9.0'
  s.dependency 'FirebaseMessagingInterop', '~> 12.9.0'
  s.dependency 'FirebaseSharedSwift', '~> 12.9.0'
