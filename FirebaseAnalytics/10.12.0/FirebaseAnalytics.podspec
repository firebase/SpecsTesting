Pod::Spec.new do |s|
    ...
    s.source           = {
        :http => 'https://dl.google.com/firebase/ios/analytics/a79f55b6d83e8615/FirebaseAnalytics-10.12.0.tar.gz'
    }
    ...
    s.subspec 'AdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement', '10.12.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'WithoutAdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/WithoutAdIdSupport', '10.12.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end
