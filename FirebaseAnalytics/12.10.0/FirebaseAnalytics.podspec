Pod::Spec.new do |s|
    ...
    s.source           = {
        :http => 'https://dl.google.com/firebase/ios/analytics/3c185b45848d98d8/FirebaseAnalytics-12.10.0.tar.gz'
    }
    ...
    s.dependency 'FirebaseInstallations', '~> 12.10.0'
    ...
    s.subspec 'Default' do |ss|
        ss.dependency 'GoogleAppMeasurement/Default', '12.10.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'Core' do |ss|
        ss.dependency 'GoogleAppMeasurement/Core', '12.10.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'IdentitySupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/IdentitySupport', '12.10.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end
