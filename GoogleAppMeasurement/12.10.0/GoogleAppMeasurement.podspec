Pod::Spec.new do |s|
    ...
    s.source           = {
        :http => 'https://dl.google.com/firebase/ios/analytics/5f5e4d8cb469941e/GoogleAppMeasurement-12.10.0.tar.gz'
    }
    ...
    s.subspec 'Default' do |ss|
        ...
        ss.ios.dependency 'GoogleAdsOnDeviceConversion', '~> 3.3.0'
    end
