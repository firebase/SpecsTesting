...
app update.
  ...
  s.dependency 'FirebaseABTesting', '~> 12.10.0'
  s.dependency 'FirebaseSharedSwift', '~> 12.10.0'
  ...
  s.dependency 'FirebaseRemoteConfigInterop', '~> 12.10.0'
