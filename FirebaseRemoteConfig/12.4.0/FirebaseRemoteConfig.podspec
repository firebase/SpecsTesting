...
app update.
  ...
  s.dependency 'FirebaseABTesting', '~> 12.4.0'
  s.dependency 'FirebaseSharedSwift', '~> 12.4.0'
  s.dependency 'FirebaseCore', '~> 12.4.0'
  s.dependency 'FirebaseInstallations', '~> 12.4.0'
  s.dependency 'GoogleUtilities/Environment', '~> 8.1'
  s.dependency 'GoogleUtilities/NSData+zlib', '~> 8.1'
  s.dependency 'FirebaseRemoteConfigInterop', '~> 12.4.0'
