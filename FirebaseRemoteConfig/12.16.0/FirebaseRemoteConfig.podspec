...
app update.
  ...
  s.dependency 'FirebaseABTesting', '~> 12.16.0'
  s.dependency 'FirebaseSharedSwift', '~> 12.16.0'
  ...
  s.dependency 'FirebaseRemoteConfigInterop', '~> 12.16.0'
